 ...
 * @author antlop
 */
public class SindiceCacheClient {
    private HttpClient httpClient;
    private String sindiceCacheUrl;

    public SindiceCacheClient(String sindiceCacheUrl){
    ...
    public JSONObject getJSONResponse(String ... urls) throws IOException{
        GetMethod method = new GetMethod(sindiceCacheUrl);
        try{
          String query ="&pretty=true";
